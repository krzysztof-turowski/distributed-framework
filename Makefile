...
example: sync_directed_hypercube_leader_example sync_directed_ring_leader_example sync_undirected_graph_leader_example sync_undirected_mesh_leader_example sync_mst_example sync_mis_example async_consensus_ben_or
...
async_consensus_ben_or:
	go run example/async_consensus_ben_or.go 6 1
